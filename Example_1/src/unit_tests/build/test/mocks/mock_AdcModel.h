...
#ifndef _MOCK_ADCMODEL_H
#define _MOCK_ADCMODEL_H
...
#define AdModel_DoNothingExceptTestPointers_ReturnThruPtr_pExample(pExample) AdModel_DoNothingExceptTestPointers_CMockReturnMemThruPtr_pExample(__LINE__, pExample, sizeof(uint32))
#define AdModel_DoNothingExceptTestPointers_ReturnArrayThruPtr_pExample(pExample, cmock_len) AdModel_DoNothingExceptTestPointers_CMockReturnMemThruPtr_pExample(__LINE__, pExample, cmock_len * sizeof(*pExample))
#define AdModel_DoNothingExceptTestPointers_ReturnMemThruPtr_pExample(pExample, cmock_size) AdModel_DoNothingExceptTestPointers_CMockReturnMemThruPtr_pExample(__LINE__, pExample, cmock_size)
