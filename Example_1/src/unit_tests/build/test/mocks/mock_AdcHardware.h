...
#ifndef _MOCK_ADCHARDWARE_H
#define _MOCK_ADCHARDWARE_H
...
void mock_AdcHardware_Init(void);
void mock_AdcHardware_Destroy(void);
void mock_AdcHardware_Verify(void);
