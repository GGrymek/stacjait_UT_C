...
static struct mock_TaskSchedulerInstance
{
  char TaskScheduler_Init_IgnoreBool;
  char TaskScheduler_Init_CallbackBool;
  CMOCK_TaskScheduler_Init_CALLBACK TaskScheduler_Init_CallbackFunctionPointer;
  int TaskScheduler_Init_CallbackCalls;
  CMOCK_MEM_INDEX_TYPE TaskScheduler_Init_CallInstance;
  char TaskScheduler_Update_IgnoreBool;
  char TaskScheduler_Update_CallbackBool;
  CMOCK_TaskScheduler_Update_CALLBACK TaskScheduler_Update_CallbackFunctionPointer;
  int TaskScheduler_Update_CallbackCalls;
  ...
  char TaskScheduler_DoUsart_CallbackBool;
  CMOCK_TaskScheduler_DoUsart_CALLBACK TaskScheduler_DoUsart_CallbackFunctionPointer;
  int TaskScheduler_DoUsart_CallbackCalls;
  ...
  char TaskScheduler_DoAdc_CallbackBool;
  CMOCK_TaskScheduler_DoAdc_CALLBACK TaskScheduler_DoAdc_CallbackFunctionPointer;
  int TaskScheduler_DoAdc_CallbackCalls;
...
void mock_TaskScheduler_Verify(void)
{
  ...
  if (Mock.TaskScheduler_Init_CallbackFunctionPointer != NULL)
  {
    call_instance = CMOCK_GUTS_NONE;
    (void)call_instance;
  }
  ...
  if (Mock.TaskScheduler_Update_CallbackFunctionPointer != NULL)
  {
    call_instance = CMOCK_GUTS_NONE;
    (void)call_instance;
  }
  ...
  if (Mock.TaskScheduler_DoUsart_CallbackFunctionPointer != NULL)
  {
    call_instance = CMOCK_GUTS_NONE;
    (void)call_instance;
  }
  ...
  if (Mock.TaskScheduler_DoAdc_CallbackFunctionPointer != NULL)
  {
    call_instance = CMOCK_GUTS_NONE;
    (void)call_instance;
  }
...
void TaskScheduler_Init(void)
{
  ...
  if (!Mock.TaskScheduler_Init_CallbackBool &&
      Mock.TaskScheduler_Init_CallbackFunctionPointer != NULL)
  {
    Mock.TaskScheduler_Init_CallbackFunctionPointer(Mock.TaskScheduler_Init_CallbackCalls++);
    UNITY_CLR_DETAILS();
    return;
  }
...
{
  Mock.TaskScheduler_Init_IgnoreBool = (char)0;
  Mock.TaskScheduler_Init_CallbackBool = (char)1;
  Mock.TaskScheduler_Init_CallbackFunctionPointer = Callback;
}

void TaskScheduler_Init_Stub(CMOCK_TaskScheduler_Init_CALLBACK Callback)
{
  Mock.TaskScheduler_Init_IgnoreBool = (char)0;
  Mock.TaskScheduler_Init_CallbackBool = (char)0;
  Mock.TaskScheduler_Init_CallbackFunctionPointer = Callback;
}
...
void TaskScheduler_Update(uint32 time)
{
  ...
  if (!Mock.TaskScheduler_Update_CallbackBool &&
      Mock.TaskScheduler_Update_CallbackFunctionPointer != NULL)
  {
    Mock.TaskScheduler_Update_CallbackFunctionPointer(time, Mock.TaskScheduler_Update_CallbackCalls++);
    UNITY_CLR_DETAILS();
    return;
  }
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringCalledMore);
  cmock_line = cmock_call_instance->LineNumber;
  {
    ...
    UNITY_TEST_ASSERT_EQUAL_HEX32(cmock_call_instance->Expected_time, time, cmock_line, CMockStringMismatch);
  }
  if (Mock.TaskScheduler_Update_CallbackFunctionPointer != NULL)
  {
    Mock.TaskScheduler_Update_CallbackFunctionPointer(time, Mock.TaskScheduler_Update_CallbackCalls++);
...
{
  Mock.TaskScheduler_Update_IgnoreBool = (char)0;
  Mock.TaskScheduler_Update_CallbackBool = (char)1;
  Mock.TaskScheduler_Update_CallbackFunctionPointer = Callback;
}

void TaskScheduler_Update_Stub(CMOCK_TaskScheduler_Update_CALLBACK Callback)
{
  Mock.TaskScheduler_Update_IgnoreBool = (char)0;
  Mock.TaskScheduler_Update_CallbackBool = (char)0;
  Mock.TaskScheduler_Update_CallbackFunctionPointer = Callback;
}
...
bool TaskScheduler_DoUsart(void)
{
  ...
  if (!Mock.TaskScheduler_DoUsart_CallbackBool &&
      Mock.TaskScheduler_DoUsart_CallbackFunctionPointer != NULL)
  {
    bool cmock_cb_ret = Mock.TaskScheduler_DoUsart_CallbackFunctionPointer(Mock.TaskScheduler_DoUsart_CallbackCalls++);
    UNITY_CLR_DETAILS();
    return cmock_cb_ret;
  }
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringCalledMore);
  ...
  if (Mock.TaskScheduler_DoUsart_CallbackFunctionPointer != NULL)
  {
    cmock_call_instance->ReturnVal = Mock.TaskScheduler_DoUsart_CallbackFunctionPointer(Mock.TaskScheduler_DoUsart_CallbackCalls++);
  }
  UNITY_CLR_DETAILS();
  return cmock_call_instance->ReturnVal;
}
...
{
  Mock.TaskScheduler_DoUsart_IgnoreBool = (char)0;
  Mock.TaskScheduler_DoUsart_CallbackBool = (char)1;
  Mock.TaskScheduler_DoUsart_CallbackFunctionPointer = Callback;
}

void TaskScheduler_DoUsart_Stub(CMOCK_TaskScheduler_DoUsart_CALLBACK Callback)
{
  Mock.TaskScheduler_DoUsart_IgnoreBool = (char)0;
  Mock.TaskScheduler_DoUsart_CallbackBool = (char)0;
  Mock.TaskScheduler_DoUsart_CallbackFunctionPointer = Callback;
}
...
bool TaskScheduler_DoAdc(void)
{
  ...
  if (!Mock.TaskScheduler_DoAdc_CallbackBool &&
      Mock.TaskScheduler_DoAdc_CallbackFunctionPointer != NULL)
  {
    bool cmock_cb_ret = Mock.TaskScheduler_DoAdc_CallbackFunctionPointer(Mock.TaskScheduler_DoAdc_CallbackCalls++);
    UNITY_CLR_DETAILS();
    return cmock_cb_ret;
  }
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringCalledMore);
  ...
  if (Mock.TaskScheduler_DoAdc_CallbackFunctionPointer != NULL)
  {
    cmock_call_instance->ReturnVal = Mock.TaskScheduler_DoAdc_CallbackFunctionPointer(Mock.TaskScheduler_DoAdc_CallbackCalls++);
  }
  UNITY_CLR_DETAILS();
  return cmock_call_instance->ReturnVal;
}
...
{
  Mock.TaskScheduler_DoAdc_IgnoreBool = (char)0;
  Mock.TaskScheduler_DoAdc_CallbackBool = (char)1;
  Mock.TaskScheduler_DoAdc_CallbackFunctionPointer = Callback;
}

void TaskScheduler_DoAdc_Stub(CMOCK_TaskScheduler_DoAdc_CALLBACK Callback)
{
  Mock.TaskScheduler_DoAdc_IgnoreBool = (char)0;
  Mock.TaskScheduler_DoAdc_CallbackBool = (char)0;
  Mock.TaskScheduler_DoAdc_CallbackFunctionPointer = Callback;
}
